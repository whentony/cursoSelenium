...
class WebDriverExpectedCondition
{
     ...
     *
     * @param string $titleRegexp The regular expression to tests against.
     ...
     *
     * @param string $urlRegexp The regular expression to tests against.
     ...
     *
     * @param WebDriverBy $by The locator used to find the element.
     * @param string $regexp The regular expression to tests against.
     * @return static Condition returns whether the element has text value equal to given one.
     */
